...
- [Courses](#courses)
  - [Python for Data Science and Machine Learning Bootcamp](#python-for-data-science-and-machine-learning-bootcamp)
    ...
    - [Python for Data Analysis - NumPy](#python-for-data-analysis---numpy)
    - [Python for Data Analysis - Pandas](#python-for-data-analysis---pandas)
    - [Python for Data Analysis - Pandas Exercises](#python-for-data-analysis---pandas-exercises)
    - [Python for Data Visualization - Matplotlib](#python-for-data-visualization---matplotlib)
    ...
    - [Python for Data Visualization - Plotly and Cufflinks](#python-for-data-visualization---plotly-and-cufflinks)
    - [Python for Data Visualization - Geographical Plotting](#python-for-data-visualization---geographical-plotting)
    - [Data Capstone Project](#data-capstone-project)
    - [Introduction to Machine Learning](#introduction-to-machine-learning)
    - [Linear Regression](#linear-regression)
    - [Cross Validation and Bias-Variance Trade-Off](#cross-validation-and-bias-variance-trade-off)
    ...
    - [Big Data and Spark with Python](#big-data-and-spark-with-python)
    - [BONUS SECTION: THANK YOU](#bonus-section-thank-you)
- [Topics](#topics)
...
1. [ ] [Python Environment Setup](README.md)
